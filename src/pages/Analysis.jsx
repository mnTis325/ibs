...
const Analysis = () => {
  ...
  const [monthName, setMonthName] = useState('Select a Month');
              ...
              <div className="px-4 py-5 flex-auto">
                <div className="tab-content tab-space">
                  ...
                  */}
                  ...
                  {/* Select Month */}
                  <select className='bg-gray-100 rounded-lg px-2 py-1 mx-2 my-3 dark:dark:bg-secondary-dark-bg'
                          onChange={(e) => {
                ...
                >
                  Compare
                    ...
                    <div className='pt-6 items-center text-center'>
                    Total Count : {totalCompareCount}
  ...
  return (
    <div className='m-2 md:m-6 p-2 md:p-6 dark:text-white bg-white dark:bg-secondary-dark-bg rounded-3xl'>
       <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mr-4 justify-start">
        <Header category='Analysis' title='Data Analysis' color={currentColor}/>
